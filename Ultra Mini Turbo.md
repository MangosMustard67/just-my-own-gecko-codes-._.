...
Name is self explanatory. This is my best code as of now and im so very proud of it :)
...
Doesnt work in battle mode, and dont use a bike if ur racing a ghost that used this code.
# NTSC-U
```
C25AA544 00000014
399EEBEC A16C0000
...
cmpwi r11, 0x120 (See if we reached the UMT threshold)
...
li r11, 0x120 (make r11 our UMT threshold)
sth r11, 0x16(r12) (Store it into our UMT value (incase our value is greater than 0x120.))
li r3, 0x2 (r3 is 2)
...
cmpwi r11, 0x120 (compare r11 to max UMT value)
bne end
b changetheMT 
end:
...
cmpwi r11,0x120 (Compare it to the threshold)
...
cmpwi r11,0x120 (r11 is still the UMT halfword because this function runs a little after the previous one.)
...
cmpwi r4, 0x0 (check if register 4 is 0 (Hotfix for ghosts))
sth r4, 0x00FC(r29) (Default instruction that changes our driftstatus to 0)
bne end (end code if r4 isnt 0)
