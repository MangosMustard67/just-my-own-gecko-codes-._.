...
cmpwi r11, 0x11A (See if we reached the UMT threshold)
...
li r11, 0x11A (make r11 our UMT threshold)
sth r11, 0x16(r12) (Store it into our UMT value (incase our value is greater than 0x11A.))
li r3, 0x2 (r3 is 2)
...
cmpwi r11, 0x11A (compare r11 to max UMT value)
bne end
b changetheMT 
end:
...
cmpwi r11,0x11A (Compare it to the threshold)
...
cmpwi r11,0x11A (r11 is still the UMT halfword because this function runs a little after the previous one.)
